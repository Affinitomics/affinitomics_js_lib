...
function callAffinitomics(postData, dataHandler, completionData, callType)
{
  ...
  nonce = 'xxxxxxxx-xxxx-9xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(c) 
  {
      var r = Math.random()*16|0, v = c == 'x' ? r : (r&0x3|0x8);
      return v.toString(16);
  });;

  postUrl = 'http://' +  g_serverUrl + '/api/' + callType + '?&ctype=' + g_ctype + '&cversion=' + g_cversion + '&nonce=' + nonce + '&user_key=' + g_apiKey;
